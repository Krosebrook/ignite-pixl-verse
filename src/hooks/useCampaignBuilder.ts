  ...
  const loadCampaign = async (id: string) => {
    ...
    try {
      ...
      setCampaign({
        ...
        assets: Array.isArray(data.assets) ? (data.assets as unknown as string[]) : [],
        platforms: Array.isArray(data.platforms) ? (data.platforms as unknown as string[]) : [],
        segments: Array.isArray(data.segments) ? (data.segments as unknown as string[]) : [],
        schedule_config: (data.schedule_config as unknown as CampaignData["schedule_config"]) || INITIAL_CAMPAIGN.schedule_config,
        goals: goals?.map(g => ({
          id: g.id,
